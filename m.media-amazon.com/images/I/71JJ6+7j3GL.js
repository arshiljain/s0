  ...
  (function (M, ha) {
        ...
        if ((b & 7) === 0) {
          ...
          if ((Ea = lj ? Ri(a, c) : Si(a, c))) {
            ((d = Tc(d, 'onBeforeInput')),
              d.length > 0 &&
                ((e = new mj('onBeforeInput', 'beforeinput', null, c, e)), g.push({ event: e, listeners: d }), (e.data = Ea)));
          }
        }
        rg(g, b);
      });
    ...
    function ih(a) {
      ...
      function w(e, g, h, k) {
        ...
        if (l === null) {
          for (; p < h.length; p++)
            ((l = n(e, h[p], k)), l !== null && ((g = f(l, g, p)), v === null ? (m = l) : (v.sibling = l), (v = l)));
          return m;
        }
      ...
      switch (b.tag) {
        ...
        case 4:
          return (
            Fe(b, b.stateNode.containerInfo),
            (d = b.pendingProps),
            a === null ? (b.child = od(b, null, d, c)) : U(a, b, d, c),
            b.child
          );
        case 11:
