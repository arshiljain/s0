...
function Ba(a,b){var c=document.createElement("a");c.href=a;a=[u,"https://app.link","https://bnc.lt"];var d=c.origin;d.endsWith("/")&&(d=d.substring(0,d.length-1));if(!a.includes(d))return!1;c=c.pathname;"/"!=c[0]&&(c="/"+c);c=za[c];if(!c)return!0;if(0<Object.keys(c).length){if(!b)return!0;for(var e in c)if(a=new RegExp(c[e]),!b.hasOwnProperty(e)||!a.test(b[e]))return!0}return!1}
function Ca(a,b){if(a||b){a="https://bnc.lt/a/"+a+"?";for(var c="tags alias channel feature stage campaign type duration sdk source data".split(" "),d=0;d<c.length;d++){var e=c[d],f=b[e];if(f)if("tags"===e&&Array.isArray(f))for(var l=0;l<f.length;l++)a=("?"===a[a.length-1]?a+e:a+"&"+e)+"="+encodeURIComponent(f[l]);else if("string"===typeof f&&0<f.length||"number"===typeof f)"data"===e&&"string"===typeof f&&(f=Da(f)),a=("?"===a[a.length-1]?a+e:a+"&"+e)+"="+encodeURIComponent(f)}return a}}
function Ea(a){a&&(a.Fa=null,a.ga=null,a.J=null,a.v=null,a.m=null,a.L=null,a.F&&delete a.F,a.G&&delete a.G,a.g.remove("branch_view_enabled"),Fa(a.g,{},!0))}function A(a,b,c){a=a.replace(/\$(\d)/g,function(d,e){return b[parseInt(e,10)-1]});c&&(a+="\n Failure Code:"+c);na&&console&&console.log(a);return a}
...
typeof b.$desktop_url&&(b.$desktop_url=b.$desktop_url.replace(/#r:[a-z0-9-_]+$/i,"").replace(/([\?&]_branch_match_id=\d+)/,""));try{v(b)}catch(d){b=k(b)}a.data=b;return a}function Ka(a){function b(d){return""!==d}if(!a||"string"!==typeof a)return"";var c=document.createElement("a");c.href=a;a=c.pathname&&c.pathname.split("/").filter(b);return Array.isArray(a)&&a.length?a[a.length-1]+c.search:c.search}
...
function Da(a){var b="",c,d=0;a=a.replace(/\r\n/g,"\n");var e="";for(c=0;c<a.length;c++){var f=a.charCodeAt(c);128>f?e+=String.fromCharCode(f):(127<f&&2048>f?e+=String.fromCharCode(f>>6|192):(e+=String.fromCharCode(f>>12|224),e+=String.fromCharCode(f>>6&63|128)),e+=String.fromCharCode(f&63|128))}for(a=e;d<a.length;){var l=a.charCodeAt(d++);e=a.charCodeAt(d++);c=a.charCodeAt(d++);f=l>>2;l=(l&3)<<4|e>>4;var h=(e&15)<<2|c>>6;var g=c&63;isNaN(e)?g=h=64:isNaN(c)&&(g=64);b=b+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)}return b}function Ta(a){return Ua(a)?atob(a):a}function Ua(a){if("string"!==typeof a||""===a||""===a.trim())return!1;try{return btoa(atob(a))===a}catch(b){return!1}}
...
function gb(){var a={};var b={};b=H(b,"$og_title",C("title"));b=H(b,"$og_description",C("description"));b=H(b,"$og_image_url",C("image"));b=H(b,"$og_video",C("video"));b=(b=H(b,"$og_type",C("type")))&&0<Object.keys(b).length?b:null;a=H(a,"og_data",b);a=H(a,"hosted_deeplink_data",Za());b=document.getElementsByTagName("title");a=H(a,"title",0<b.length?b[0].innerText:null);b=document.querySelector('meta[name="description"]');a=H(a,"description",b&&b.content?b.content:null);b=document.querySelector('link[rel="canonical"]');
return(a=H(a,"canonical_url",b&&b.href?b.href:null))&&0<Object.keys(a).length?a:{}}var hb="ADD_TO_CART ADD_TO_WISHLIST VIEW_CART INITIATE_PURCHASE ADD_PAYMENT_INFO PURCHASE SPEND_CREDITS SEARCH VIEW_ITEM VIEW_ITEMS RATE SHARE COMPLETE_REGISTRATION COMPLETE_TUTORIAL ACHIEVE_LEVEL UNLOCK_ACHIEVEMENT LOGIN SUBSCRIBE START_TRIAL INVITE RESERVE VIEW_AD CLICK_AD INITIATE_STREAM COMPLETE_STREAM".split(" "),ib="transaction_id revenue currency shipping tax coupon affiliation search_query description".split(" ");
...
function lb(a){var b={};b=H(b,"http_origin",document.URL);b=H(b,"user_agent",navigator.userAgent);b=H(b,"language",$a());b=H(b,"screen_width",screen.width||0);b=H(b,"screen_height",screen.height||0);b=H(b,"http_referrer",document.referrer);b=H(b,"browser_fingerprint_id",a.L);b=H(b,"developer_identity",a.m);b=H(b,"identity",a.m);b=H(b,"sdk","web");b=H(b,"sdk_version","2.89.2");b=mb(b,"model",y?y.model:"");return b=mb(b,"os_version",y?y.platformVersion:"")}
...
var ub={destination:u,endpoint:"/v1/open",method:"POST",h:{browser_fingerprint_id:K(!1,1),alternative_browser_fingerprint_id:K(!1,1),identity_id:K(!1,1),identity:K(!1,1),link_identifier:K(!1,1),sdk:K(!1,1),options:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),current_url:K(!1,1),screen_height:K(!1,2),screen_width:K(!1,2),model:K(!1,1),os_version:K(!1,1)}},vb={destination:"https://app.link",endpoint:"/_r",method:"GET",S:!0,h:{sdk:K(!0,1),_t:K(!1,1),branch_key:K(!0,1)}},wb={destination:u,
endpoint:"/v1/url",method:"POST",sa:"obj",h:tb({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,1),data:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1),instrumentation:K(!1,1)})},xb={destination:u,endpoint:"/v1/qr-code",method:"POST",sa:"obj",h:tb({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,1),data:K(!1,1),qr_code_settings:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1)})},yb={destination:u,endpoint:"/v1/deepview",
S:!0,method:"POST",h:tb({campaign:K(!1,1),_t:K(!1,1),channel:K(!1,1),data:K(!0,1),feature:K(!1,1),link_click_id:K(!1,1),open_app:K(!1,4),append_deeplink_path:K(!1,4),stage:K(!1,1),tags:K(!1,3),deepview_type:K(!0,1),source:K(!0,1)})},zb={destination:u,endpoint:"/v2/event/standard",method:"POST",h:{name:K(!0,1),user_data:K(!0,1),custom_data:K(!1,1),event_data:K(!1,1),content_items:K(!1,1),customer_event_alias:K(!1,1)}},Ab={destination:u,endpoint:"/v2/event/custom",method:"POST",h:{name:K(!0,1),user_data:K(!0,
1),custom_data:K(!1,1),event_data:K(!1,1),content_items:K(!1,1),customer_event_alias:K(!1,1)}},Bb={destination:u,endpoint:"/v1/pageview",method:"POST",h:tb({event:K(!0,1),metadata:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),branch_view_id:K(!1,1),no_journeys:K(!1,4),user_language:K(!1,1),open_app:K(!1,4),has_app_websdk:K(!1,4),source:K(!1,1),feature:K(!1,1),is_iframe:K(!1,4),data:K(!1,0),callback_string:K(!1,1),audience_rule_id:K(!1,1),journey_dismissals:K(!1,0),identity_id:K(!1,1),
identity:K(!0,1),session_referring_link_data:K(!1,1),session_link_click_id:K(!1,1)})},Cb={destination:u,endpoint:"/v1/dismiss",method:"POST",h:tb({event:K(!0,1),metadata:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),branch_view_id:K(!1,1),no_journeys:K(!1,4),user_language:K(!1,1),open_app:K(!1,4),has_app_websdk:K(!1,4),source:K(!1,1),feature:K(!1,1),is_iframe:K(!1,4),data:K(!1,0),callback_string:K(!1,1),audience_rule_id:K(!1,1),journey_dismissals:K(!1,0),dismissal_source:K(!1,1)})},Db=
{destination:u,endpoint:"/v1/cpid",method:"POST",h:{user_data:K(!0,1)}},Eb={destination:u,endpoint:"/v1/cpid/latd",method:"POST",h:{user_data:K(!0,1)}};function Fb(){for(var a=["session","cookie","pojo"],b=0;b<a.length;b++){var c=this[a[b]];c="function"===typeof c?c():c;if(c.isEnabled())return c.H={},c}}function L(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Gb(a){return"true"===a?!0:"false"===a?!1:a}function Hb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}
...
function Nb(a,b,c){var d,e=b.destination+b.endpoint,f=/^[0-9]{15,20}$/,l=/key_(live|test)_[A-Za-z0-9]{32}/;if("undefined"!==typeof b.i)for(g in b.i)if(b.i.hasOwnProperty(g)){if(d="function"===typeof b.i[g]?b.i[g](b.endpoint,g,c[g]):d)return{error:d};e+="/"+c[g]}var h={};if("undefined"!==typeof b.h&&"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint)for(g in b.h){if(b.h.hasOwnProperty(g)){if(d=b.h[g](b.endpoint,g,c[g]))return{error:d};d=c[g];"undefined"!==typeof d&&""!==d&&null!==d&&(h[g]=d)}}else if("/v1/pageview"===
b.endpoint||"/v1/dismiss"===b.endpoint)D(h,c),h.branch_requestMetadata&&(h.metadata=D(h.metadata||{},h.branch_requestMetadata),delete h.branch_requestMetadata);c.hasOwnProperty("branch_requestMetadata")&&c.branch_requestMetadata&&"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint&&(h.metadata=w(c.branch_requestMetadata));c.branch_dma_data&&(rb(h,c.branch_dma_data,b.endpoint),h.branch_dma_data&&delete h.branch_dma_data);if("POST"===b.method)try{var g=h;"undefined"===typeof g&&(g={});if(c.branch_key&&
l.test(c.branch_key))g.branch_key=c.branch_key;else if(c.app_id&&f.test(c.app_id))g.app_id=c.app_id;else if(c.instrumentation)g.instrumentation=c.instrumentation;else throw Error(A("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}catch(n){return{error:n.message}}("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&h.metadata&&(h.metadata=w(h.metadata||{}));"/v1/open"===b.endpoint&&(h.options=w(h.options||{}));return{data:Mb(a,h,""),url:e.replace(/^\//,"")}}
...
function Ob(a,b,c,d,e){var f=Date.now(),l=ua;0===a.l&&Pa()&&a.l++;var h="branch_callback__"+a.l++,g=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(Da(k(c))):"";var n=window.setTimeout(function(){window[h]=function(){};H(x,l,wa(f));e(Error("Request timed out"),null,504)},qa);window[h]=function(m){window.clearTimeout(n);e(null,m)};a.createScript(b+(0>b.indexOf("?")?"?":"")+(c?g+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+h,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){H(x,l,wa(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(m){}delete window[h]})}
function Pb(a,b,c,d,e,f,l,h){var g=Date.now(),n=ua,m=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");h&&(m.responseType=h);m.ontimeout=function(){H(x,n,wa(g));f(Error("Request timed out"),null,504)};m.onerror=function(q){var r="Error in API: URL - "+(m.responseURL||"Unknown")+", Status - "+(m.status||"No status available")+", Response - "+(m.responseText||"No response text available");console.log(r);f(Error(q.error||r),null,m.status)};m.onreadystatechange=function(){if(4===
m.readyState)if(H(x,n,wa(g)),200===m.status){if("arraybuffer"===m.responseType)var q=m.response;else if(l)q=m.responseText;else try{q=v(m.responseText)}catch(r){q={}}f(null,q,m.status)}else if("4"===m.status.toString().substring(0,1)||"5"===m.status.toString().substring(0,1))m.responseURL&&m.responseURL.includes("v2/event")?f(m.responseText,null,m.status):(q="Error in API: URL - "+(m.responseURL||"Unknown")+", Status - "+(m.status||"No status available")+", Response - "+(m.responseText||"No response text available"),
console.log(q),f(Error(q),null,m.status))};try{m.open(d,b,!0),m.timeout=qa,m.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),m.send(c)}catch(q){e.set("use_jsonp",!0),Ob(a,b,c,d,f)}}
function Qb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.S?Ob(a,m,c,b.method,l):Pb(a,m,n,b.method,d,l,Y,p)}function l(t,G,E){"function"===typeof a.fa&&a.fa(m,b.method,q,t,E,G);t&&0<r&&"5"===(E||"").toString().substring(0,1)?(r--,window.setTimeout(function(){f()},pa)):e(t,G)}ua=b.endpoint+"-brtt";"/v1/url"===b.endpoint&&1<Object.keys(x).length&&(delete x["-brtt"],c.instrumentation=w(D({},x)),x={});if(z)for(var h=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id",
"identity"],g=0;g<h.length;g++)c.hasOwnProperty(h[g])&&delete c[h[g]];h=Nb(a,b,c);if(h.error)return e(Error(w({message:h.error,endpoint:b.endpoint,data:c})));var n="";if("GET"===b.method)var m=h.url+"?"+h.data;else m=h.url,n=h.data;var q;d.get("use_jsonp")||b.S?q=c:q=n;var r=oa;if(z&&Ba(m,c))return Aa?l(Error("Requested operation cannot be completed since tracking is disabled"),null,300):l(null,{},200);var Y=!1;if("/v1/qr-code"===b.endpoint){Y=!0;var p="arraybuffer"}f()};function M(a){a&&a.parentNode&&a.parentNode.removeChild(a)}function Rb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Sb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Tb(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
function Vb(a){function b(c){function d(){return Math.max(document.documentElement.clientHeight,window.innerHeight||0)/100}function e(){return Math.max(document.documentElement.clientWidth,window.innerWidth||0)/100}if(!c)return 0;var f=c.replace(/[0-9,\.]/g,"");c=c.match(/\d+/g);var l=parseInt(0<c.length?c[0]:"0",10);return parseInt({px:function(h){return h},em:function(h){return document.body.currentStyle?h*b(document.body.currentStyle.fontSize):h*parseFloat(window.getComputedStyle(document.body).fontSize)},
rem:function(h){return document.documentElement.currentStyle?h*b(document.documentElement.currentStyle.fontSize):h*parseFloat(window.getComputedStyle(document.documentElement).fontSize)},vw:function(h){return h*e()},vh:function(h){return h*d()},vmin:function(h){return h*Math.min(d(),e())},vmax:function(h){return h*Math.max(d(),e())},"%":function(){return document.body.clientWidth/100*l}}[f](l),10)}return(b("76px")+b(a)).toString()+"px"}
function Wb(a,b){a=a.get("hideBanner",!0);if(b.ta&&navigator&&Number(navigator.doNotTrack))return!1;try{"string"===typeof a&&(a=v(a))}catch(d){a=!1}a="number"===typeof a?new Date>=new Date(a):!a;var c=b.R;"number"===typeof c&&(c=!1);return!document.getElementById("branch-banner")&&!document.getElementById("branch-banner-iframe")&&(a||c)&&(b.V&&"android"===F()||b.ua&&"ipad"===F()||b.Z&&"ios"===F()||b.W&&"blackberry"===F()||b.Y&&"windows_phone"===F()||b.X&&"kindle"===F())};function Xb(a,b){var c=".branch-banner-is-active { -webkit-transition: all 0.375s ease; transition: all 00.375s ease; }\n#branch-banner { width:100%; z-index: 99999; font-family: Helvetica Neue, Sans-serif; -webkit-font-smoothing: antialiased; -webkit-user-select: none; -moz-user-select: none; user-select: none; -webkit-transition: all 0.25s ease; transition: all 00.25s ease; }\n#branch-banner .button{ border: 1px solid "+(a.buttonBorderColor||("dark"===a.theme?"transparent":"#ccc"))+"; background: "+
...
function cc(a,b,c){b='<div id="branch-banner-form-container"><a id="branch-mobile-action" class="button" href="#" target="_parent">'+(((N(b)||{}).has_app?a.qa:a.na)+"</a></div>");a.M?$b(a,b,c):(a=bc(a,b,document),c(a))};function dc(a,b,c,d){function e(g,n){"function"===typeof g&&(n=g,g={});g=g||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.R?d.set("hideBanner",Tb(b.R),!0):d.set("hideBanner",!0,!0);g.da?("top"===b.position?document.body.style.marginTop=l:"bottom"===b.position&&(document.body.style.marginBottom=h),Sb("branch-banner-is-active"),M(f),M(document.getElementById("branch-css")),n()):(setTimeout(function(){M(f);M(document.getElementById("branch-css"));
n()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=l:"bottom"===b.position&&(document.body.style.marginBottom=h);Sb("branch-banner-is-active")},20))}if(!Wb(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var f,l=document.body.style.marginTop,h=document.body.style.marginBottom;cc(b,d,function(g){function n(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");O(a,"didShowBanner")}f=g;Xb(b,f);c.channel=c.channel||"app banner";
g=b.M?f.contentWindow.document:document;if(!["other","desktop"].includes(F())){b.open_app=b.ra;b.append_deeplink_path=b.ja;b.make_new_link=b.oa;b.deepview_type="banner";a.deepview(c,b);var m=g.getElementById("branch-mobile-action");m&&(m.onclick=function(r){r.preventDefault();a.deepviewCta()})}m=Ub("margin-top");var q=Ub("margin-bottom");Rb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Vb(m):"bottom"===b.position&&(document.body.style.marginBottom=Vb(q));
if(m=g.getElementById("branch-banner-close"))m.onclick=function(r){r.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})};if(g=g.getElementById("branch-banner-modal-background"))g.onclick=function(r){r.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})};b.da?n():setTimeout(n,20)});return e};function ec(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};var fc={},P,Q,R,gc,hc,ic,jc,kc,lc=1;function mc(){P="top";Q="absolute";R="76px";hc=gc=!1}mc();var nc=[],oc=!1,pc=window.innerHeight,qc=window.innerWidth;window.innerHeight<window.innerWidth&&(pc=window.innerWidth,qc=window.innerHeight);
...
function Rc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";rc=Ub("margin-top");var c=+rc.slice(0,-2);sc=Ub("margin-bottom");var d=+sc.slice(0,-2),e=+R.slice(0,-2);a||("top"===P?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===P&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<nc.length&&nc.forEach(function(f){var l,h=window.getComputedStyle(f);h&&(l=gc&&"fixed"===h.getPropertyValue("position"));l||(f.style.marginTop=R)});"top"===Gc&&
...
function Sc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Dc||(a="body { -webkit-transition: all 0.25s ease; }\n",document.body.style.transition="all 00.25s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");a=a||"";if(ic){var c=R,d=fc.va,e=Q;"overlay"===jc&&(d=c="100%!important",e="fixed");a=a+("#branch-banner-iframe-embed { z-index: 99999!important; height: "+
...
function Yc(a,b,c,d,e,f,l){var h=V;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(g){g.addEventListener("click",function(){O(T,"didClickJourneyCTA",U);Ec=!0;d();Zc(e)})}),$c(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,l,h,"click"),$c(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,l,h,"click"),$c(".branch-banner-dismiss-background","didClickJourneyBackgroundDismiss",c,e,a,b,f,l,h,"click"),$c(".branch-banner-dismiss-background",
"didScrollJourneyBackgroundDismiss",c,e,a,b,f,l,h,"touchmove"))}function $c(a,b,c,d,e,f,l,h,g,n){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(m){m.addEventListener(n,function(){ad(b,c,d,e,f,l,h,g)})})}function bd(a,b,c){var d=a.get("journeyDismissals",!0);d=d?v(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",w(d),!0)}
...
function dd(a,b){var c={},d=Za();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);a=a.O(ed(null,c),null,T,!0);if(U&&U.journey_link_data){H(a,"journey_id",U.journey_link_data.journey_id);H(a,"journey_name",cd(U.journey_link_data.journey_name));H(a,"view_id",U.journey_link_data.view_id);H(a,"view_name",cd(U.journey_link_data.view_name));H(a,"channel",cd(U.journey_link_data.channel));H(a,"campaign",cd(U.journey_link_data.campaign));try{H(a,"tags",JSON.stringify(U.journey_link_data.tags))}catch(e){a.tags=
JSON.stringify([])}}H(a,"dismissal_source",b);return a}
function ad(a,b,c,d,e,f,l,h){var g=l?0:Xc(f);O(T,a,U);Ec=!0;Zc(c);if(!l){void 0!==g&&b.set("globalJourneysDismiss",g,!0);bd(b,d,e);var n=function(){T.removeListener(n);var m=dd(h,xa[a]);T.j(Cb,m,function(q,r){!q&&f&&f.dismissRedirect?window.location=f.dismissRedirect:!q&&"object"===typeof r&&r.template&&h.U(r,null,!1)&&h.P(r.template,m,m.branch_view_id||r.event_data.branch_view_data.id,r.event_data.branch_view_data,!1,r.journey_link_data)})};T.addListener("branch_internal_event_didCloseJourney",n)}}
...
function Zc(a,b){Cc||(tc=!0);if(Dc&&!Cc){document.body.style.transition="all 00.25s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";c+="body { -webkit-transition: all 0.25s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c}"top"===P?a.style.top="-"+R:"bottom"===
P&&(a.style.bottom="-"+R);O(T,"willCloseJourney",U);"top"===P?document.body.style.marginTop=rc:"bottom"===P&&(document.body.style.marginBottom=sc);setTimeout(function(){M(a);M(document.getElementById("branch-css"));M(document.getElementById("branch-iframe-css"));M(document.getElementById("branch-journey-cta"));(!Cc||Ec)&&nc&&0<nc.length?nc.forEach(function(d){d.style.marginTop=0}):(Fc=Cc,Gc=P,Hc=nc);Sb("branch-banner-is-active");Sb("branch-banner-no-scroll");oc&&(oc=!1,window.removeEventListener("resize",
...
function jd(a,b,c){var d=b?"OPEN":"GET";Ic(a);var e=Jc(a);e&&(d=Lc(e,b),Mc(e));var f=Nc(a);Oc(a);var l=Kc(a);a=Pc(a);b=document.createElement("div");b.id="branch-banner-iframe-embed";var h=Qc();h.onload=function(){var g=a,n=F();var m="ios"===n||"ipad"===n?"branch-banner-ios":"android"===n?"branch-banner-android":"branch-banner-other";n=h.contentDocument||h.contentWindow.document;n.head||(n.documentElement||n).appendChild(n.createElement("head"));n.body||(n.documentElement||n).appendChild(n.createElement("body"));n.body.innerHTML=
g;n.body.className=m;(g=n.querySelector('meta[name="accessibility"]'))&&"wcag"===g.content&&(g=n.createElement("script"),g.type="text/javascript",g.text="\n\t\t\tvar focusableElements = 'button, [href], input, select, textarea, [role=\"button\"], h1, [role=\"text\"], .branch-banner-content';\n\t\t\tvar modal = document.getElementById('branch-banner');\n\t\t\tvar focusableContent = modal.querySelectorAll(focusableElements);\n\t\t\tvar focusElementIdx = 0;\n\n\t\t\tfunction handleKeyboardNavigation(e) {\n\t\t\t\tvar isTabPressed = e.key === 'Tab' || e.keyCode === 9;\n\t\t\t\tvar isEnterPressed = e.key === 'Enter' || e.keyCode === 13;\n\t\t\t\t\n\t\t\t\t// Handle Tab key for focus navigation\n\t\t\t\tif (isTabPressed) {\n\t\t\t\t\tif (e.shiftKey) {\n\t\t\t\t\t\tif (focusElementIdx <= 0) {\n\t\t\t\t\t\t\tfocusElementIdx = focusableContent.length - 1;\n\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\tfocusElementIdx = focusElementIdx - 1;\n\t\t\t\t\t\t}\n\t\t\t\t\t} else {\n\t\t\t\t\t\tif (focusElementIdx >= focusableContent.length - 1) {\n\t\t\t\t\t\t\tfocusElementIdx = 0;\n\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\tfocusElementIdx = focusElementIdx + 1;\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\n\t\t\t\t\tfocusableContent[focusElementIdx].focus();\n\t\t\t\t\te.preventDefault();\n\t\t\t\t\treturn;\n\t\t\t\t}\n\t\t\t\t\n\t\t\t\t// Handle Enter key for activation\n\t\t\t\tif (isEnterPressed) {\n\t\t\t\t\t// Get the currently focused element\n\t\t\t\t\tvar focusedElement = document.activeElement;\n\t\t\t\t\tif (focusedElement && (\n\t\t\t\t\t\tfocusedElement.tagName === 'BUTTON' || \n\t\t\t\t\t\tfocusedElement.getAttribute('role') === 'button' ||\n\t\t\t\t\t\tfocusedElement.tagName === 'A'\n\t\t\t\t\t)) {\n\t\t\t\t\t\t// Simulate a click on the element\n\t\t\t\t\t\tfocusedElement.click();\n\t\t\t\t\t\te.preventDefault();\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\n\t\t\tfunction autoFocus(delay) {\n\t\t\t\tsetTimeout(function() { focusableContent[focusElementIdx].focus() }, delay);\n\t\t\t}\n\n\t\t\tdocument.addEventListener('keydown', handleKeyboardNavigation);\n\t\t\tautoFocus(100);\n\t\t\t\n\t\t",
n.querySelector("body").append(g));Rc(l);g=document.createElement("style");g.type="text/css";g.id="branch-css";g.innerHTML=f;J(g);n=h.contentWindow.document;n.head.appendChild(g);g=ic&&"overlay"===jc;if((hc||gc)&&!g){var q=n.getElementsByClassName("branch-banner-content")[0];!n.getElementsByClassName("branch-banner-dismiss-background")[0]&&q&&(q.style.height=R)}"top"===P?h.style.top="-"+R:"bottom"===P&&(h.style.bottom="-"+R);try{q=n.getElementsByClassName("branch-banner-content")[0];var r=window.getComputedStyle(q).getPropertyValue("background-color").split(", ");
r[3]&&0===parseFloat(r[3])&&(h.style.boxShadow="none")}catch(Y){}q=d;(r=h.contentWindow.document)&&r.getElementById("branch-mobile-action")&&(r=r.getElementById("branch-mobile-action"),r.innerHTML=q,r.setAttribute("aria-label",q));q=Object.assign({},U);q.bannerHeight=R;q.isFullPageBanner=gc;q.bannerPagePlacement=P;q.isBannerInline="absolute"===Q;q.isBannerSticky="fixed"===Q;O(T,"willShowJourney",q);Tc(h,l);c(h)};ic?(b.appendChild(h),document.body.appendChild(b)):document.body.prepend(h)}
...
V.P=function(a,b,c,d,e,f){if(!tc){kc=c;fd(f);var l=d.audience_rule_id;(d=document.getElementById("branch-iframe-css"))&&d.parentElement&&d.parentElement.removeChild(d);var h=document.createElement("div");h.id="branch-banner";document.body.insertBefore(h,null);Rb(h,"branch-banner-is-active");var g=!1,n=b.callback_string,m=null,q=T.g;if(a){var r=Jc(a)||{};a=id(a);var Y=window.setTimeout(function(){window[n]=function(){}},qa);window[n]=function(p){window.clearTimeout(Y);g||(m=p,Yc(c,l,q,m,null,r,e))};
jd(a,b.has_app_websdk,function(p){Ac=p;null===p?g=!0:(Yc(c,l,q,m,p,r,e),ta&&(x["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(h))})}else document.body.removeChild(h)}};
V.O=function(a,b,c,d){T=c;b||(b={});a||(a={});Dc=b.disable_entry_animation||!1;Cc=b.disable_exit_animation||!1;var e=D({},c.s),f=N(c.g)||{},l=f.hasOwnProperty("has_app")?f.has_app:!1,h=f.hasOwnProperty("identity")?f.identity:null,g=c.g.get("journeyDismissals",!0),n=(b.user_language||$a()||"en").toLowerCase()||null,m=nb(W(c)),q;(q=b.branch_view_id)||(q="_branch_view_id".replace(/[\[\]]/g,"\\$&"),q=(q=(new RegExp("[?&]"+q+"(=([^&#]*)|&|#|$)")).exec(Ia()))&&q[2]?decodeURIComponent(q[2].replace(/\+/g,
" ")):"");q=q||null;c=b.make_new_link?null:Ka(W(c,!0));var r=f.hasOwnProperty("session_link_click_id")?f.session_link_click_id:null;e.event=d?"dismiss":"pageview";e.metadata=a;e=H(e,"initial_referrer",m);e=H(e,"branch_view_id",q);e=H(e,"no_journeys",b.no_journeys);e=H(e,"is_iframe",B());e=H(e,"journey_dismissals",g);e=H(e,"identity",h);e=H(e,"session_link_click_id",r);e.user_language=n;e.open_app=b.open_app||!1;e.has_app_websdk=l;e.feature="journeys";e.callback_string="branch_view_callback__"+lc++;
...
function X(a,b,c){return function(){var d=this,e=arguments[arguments.length-1];if(0===a||"function"!==typeof e){var f=function(){};var l=Array.prototype.slice.call(arguments)}else l=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=e;d.ha(function(h){function g(n,m){try{if(n&&0===a)throw n;1===a?f(n):2===a&&f(n,m)}finally{h()}}if(!c){if(1===d.A)return g(Error(A("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.A)return g(Error(A("Branch SDK initialization failed, so further methods cannot be called",d.B,
d.D)),null);if(0===d.A||!d.A)return g(Error(A("Branch SDK not initialized")),null)}l.unshift(g);b.apply(d,l)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ha=ec();this.g=new Fb;this.$=new Lb;this.u=[];this.ca="web2.89.2";this.l={};this.B=this.A=0;this.D=null}
Z.prototype.j=function(a,b,c){this.aa&&(b.app_id=this.aa);this.o&&(b.branch_key=this.o);(a.h&&a.h.session_id||a.i&&a.i.session_id)&&this.J&&(b.session_id=this.J);(a.h&&a.h.identity_id||a.i&&a.i.identity_id)&&this.v&&(b.identity_id=this.v);0>a.endpoint.indexOf("/v1/")?(a.h&&a.h.developer_identity||a.i&&a.i.developer_identity)&&this.m&&(b.developer_identity=this.m):(a.h&&a.h.identity||a.i&&a.i.identity)&&this.m&&(b.identity=this.m);(a.h&&a.h.link_click_id||a.i&&a.i.link_click_id)&&this.ea&&(b.link_click_id=
this.ea);(a.h&&a.h.sdk||a.i&&a.i.sdk)&&this.ca&&(b.sdk=this.ca);(a.h&&a.h.browser_fingerprint_id||a.i&&a.i.browser_fingerprint_id)&&this.L&&(b.browser_fingerprint_id=this.L);z&&(b.tracking_disabled=z);if(this.l)for(var d in this.l)this.l.hasOwnProperty(d)&&(b.branch_requestMetadata||(b.branch_requestMetadata={}),b.branch_requestMetadata[d]=this.l[d]);va.hasOwnProperty(a.endpoint)&&(d=this.g.get("branch_dma_data",!0),b.branch_dma_data=d?v(d):null);"/_r"!==a.endpoint&&(a.destination=u);return Qb(this.$,
...
Z.prototype.init=X(2,function(a,b,c){function d(){if("undefined"!==typeof document.hidden){var p="hidden";var t="visibilitychange"}else"undefined"!==typeof document.mozHidden?(p="mozHidden",t="mozvisibilitychange"):"undefined"!==typeof document.msHidden?(p="msHidden",t="msvisibilitychange"):"undefined"!==typeof document.webkitHidden&&(p="webkitHidden",t="webkitvisibilitychange");t&&!g.ka&&(g.ka=!0,document.addEventListener(t,function(){document[p]||(l(null),"function"===typeof g.G&&g.G())},!1))}function e(p,
t){t&&(t=h(t),z||(t=f(t),Fa(g.g,t,q)),g.A=3,t.data_parsed=t.data&&0!==t.data.length?v(t.data):{});if(p)return g.A=2,g.B||(g.B=1,g.D=p.message),a(p,t&&Ga(t));try{a(p,t&&Ga(t))}catch(E){}finally{g.renderFinalize()}p=gb();(t=I(c.metadata,"object")?c.metadata:null)&&(t=ob(p.hosted_deeplink_data,t))&&0<Object.keys(t).length&&(p.hosted_deeplink_data=t);var G=V.O(ed(c,p),c,g,!1);g.renderQueue(function(){g.j(Bb,G,function(E,S){E||"object"!==typeof S||(E=G.branch_view_id?!0:!1,V.U(S,c,E)?V.P(S.template,G,
G.branch_view_id||S.event_data.branch_view_data.id,S.event_data.branch_view_data,E,S.journey_link_data):((S.auto_branchify||!n&&Ra("branchify_url")&&W(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(T,"willNotShowJourney")));z&&(Aa=!0)})})}function f(p){q&&(p.identity=g.m);return p}function l(p){var t={sdk:"2.89.2",branch_key:g.o},G=N(g.g)||{},E=N(g.g,!0)||{};E.browser_fingerprint_id&&(t._t=E.browser_fingerprint_id);Pa()||Qa()||g.j(vb,t,function(S,ac){S&&(g.B=3,g.D=
S.message);ac&&(G.browser_fingerprint_id=ac)});p&&p(null,G)}function h(p){p.link_click_id&&(g.ea=p.link_click_id.toString());p.session_link_click_id&&(g.Ga=p.session_link_click_id.toString());p.session_id&&(g.J=p.session_id.toString());p.identity_id&&(g.v=p.identity_id.toString());p.identity&&(g.m=p.identity.toString());p.link&&(g.ga=p.link);if(p.referring_link){var t=p.referring_link;p.referring_link=t?"http"!==t.substring(0,4)?"https://bnc.lt"+t:t:null}!p.click_id&&p.referring_link&&(p.click_id=
Ka(p.referring_link));g.L=p.browser_fingerprint_id;return p}ta&&(x["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.A=1;-1<b.indexOf("key_")?g.o=b:g.aa=b;c=c&&I(c,"object")?c:{};oa=(g.N=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:qa;ra=c&&c.nonce?c.nonce:ra;na=c&&c.enableLogging?c.enableLogging:na;z=c&&c.tracking_disabled&&
!0===c.tracking_disabled?!0:!1;ya=c&&c.enableExtendedJourneysAssist?c.enableExtendedJourneysAssist:ya;sa=c&&c.extendedJourneysAssistExpiryTime&&Number.isInteger(c.extendedJourneysAssistExpiryTime)?c.extendedJourneysAssistExpiryTime:sa;Aa=!1;qb();z&&Ea(g);b=N(g.g,!0);g.v=b&&b.identity_id;b=N(g.g);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Ra("_branch_match_id")||La(),q=!g.v;g.K=!!g.g.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ra("branchify_url"))Yb(g.g,
{data:""}),Yb(g.g,{referring_link:""}),d(),l(e);else{b={sdk:"2.89.2",branch_key:g.o};var r=N(g.g,!0)||{};r.browser_fingerprint_id&&(b._t=r.browser_fingerprint_id);r.identity&&(g.m=r.identity);var Y=parseInt(Ra("[?&]_open_delay_ms"),10);Pa()||Qa()?pb(function(){g.j(ub,{link_identifier:m,browser_fingerprint_id:m||r.browser_fingerprint_id,identity:r.identity?r.identity:null,alternative_browser_fingerprint_id:r.browser_fingerprint_id,options:c,initial_referrer:nb(W(g)),current_url:B()&&Ma()?window.top.location.href:
window.location.href,screen_height:screen.height||0,screen_width:screen.width||0,model:y?y.model:null,os_version:y?y.platformVersion:null},function(p,t){p&&(g.B=2,g.D=p.message);p||"object"!==typeof t||(t.branch_view_enabled&&(g.K=!!t.branch_view_enabled,g.g.set("branch_view_enabled",g.K)),m&&(t.click_id=m));d();e(p,t)})},Y):g.j(vb,b,function(p,t){if(p)return g.B=3,g.D=p.message,e(p,null);pb(function(){g.j(ub,{link_identifier:m,browser_fingerprint_id:m||t,identity:r.identity?r.identity:null,alternative_browser_fingerprint_id:r.browser_fingerprint_id,
options:c,initial_referrer:nb(W(g)),current_url:B()&&Ma()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0,model:y?y.model:null,os_version:y?y.platformVersion:null},function(G,E){G&&(g.B=2,g.D=G.message);G||"object"!==typeof E||(E.branch_view_enabled&&(g.K=!!E.branch_view_enabled,g.g.set("branch_view_enabled",g.K)),m&&(E.click_id=m));d();e(G,E)})},Y)})}},!0);
Z.prototype.renderQueue=X(0,function(a,b){this.ia?b():(this.C=this.C||[],this.C.push(b));a(null,null)});Z.prototype.renderFinalize=X(2,function(a){this.C&&0<this.C.length&&(this.C.forEach(function(b){b.call(this)}),delete this.C);this.ia=!0;a(null,null)});Z.prototype.data=X(2,function(a){var b=Ga(N(this.g));b.referring_link=W(this);b.data_parsed=b.data&&0!==b.data.length?v(b.data):{};a(null,b)});Z.prototype.first=X(2,function(a){a(null,Ga(N(this.g,!0)))});
Z.prototype.setIdentity=X(2,function(a,b){if(b){var c={v:this.v,J:this.J,link:this.ga,Ea:b};this.m=b;Zb(this.g,{identity:b});a(null,c)}else a(Error(A("setIdentity - required argument identity should have a non-null value")))});Z.prototype.logout=X(1,function(a){this.m=null;Zb(this.g,{identity:null},!0);a(null)});Z.prototype.getBrowserFingerprintId=X(2,function(a){var b=N(this.g,!0)||{};a(null,b.browser_fingerprint_id||null)});
Z.prototype.crossPlatformIds=X(2,function(a){this.j(Db,{user_data:w(lb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=X(2,function(a,b){b=I(b,"number")?b:null;var c=lb(this);H(c,"attribution_window",b);this.j(Eb,{user_data:w(c)},function(d,e){return a(d||null,e||null)})});
Z.prototype.track=X(1,function(a,b,c,d){c=c||{};d=d||{};ra=d.nonce?d.nonce:ra;if("pageview"===b){(b=ob(Za(),c))&&0<Object.keys(b).length&&(c.hosted_deeplink_data=b);var e=V.O(ed(d,c),d,this,!1);this.j(Bb,e,function(f,l){if(!f&&"object"===typeof l){var h=e.branch_view_id?!0:!1;V.U(l,d,h)?V.P(l.template,e,e.branch_view_id||l.event_data.branch_view_data.id,l.event_data.branch_view_data,h,l.journey_link_data):O(T,"willNotShowJourney")}"function"===typeof a&&a.apply(this,arguments)})}else console.warn("track method currently supports only pageview event.")});
...
d,yb,b,function(l,h){if(l)return z||(d.F=function(){window.top.location=e}),a(l);"function"===typeof h&&(d.F=h);a(null)});d.G()});
